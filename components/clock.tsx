    ...
    >
      ...
      {clockType !== 'digital' && (
        ...
        >
          ...
          <div
            className={cn(
              'absolute w-[1px] rounded-full origin-bottom z-10 transition-colors duration-500',
              themeStyles.hourHand,
              animationClass
            )}
            style={{
          ...
          <div
            className={cn(
              'absolute w-[0.8px] rounded-full origin-bottom z-20 opacity-70 transition-colors duration-500',
              themeStyles.minuteHand,
              animationClass
            )}
            style={{
          ...
          {showSeconds && (
            <div
              className={cn(
                'absolute w-[0.4px] rounded-full origin-bottom z-30 transition-colors duration-500',
                themeStyles.secondHand,
                animationClass
              )}
              style={{
          ...
          <div
            className={cn(
              'absolute w-1.2 h-1.2 rounded-full z-40 flex items-center justify-center transition-colors duration-500',
              themeStyles.centerDot
            )}
          >
            <div
              className={cn(
                'w-0.4 h-0.4 rounded-full transition-colors duration-500',
                themeStyles.centerDotInner
              )}
            />
          </div>
        </div>
      ...
      {clockType !== 'analog' && (
        ...
        >
          <div
            className={cn(
              'font-black tracking-[0.2em] tabular-nums transition-colors duration-500',
              digitalTextSizes[size],
              themeStyles.digitalTime
            )}
          >
            {time
          ...
          {showDate && (
            <div
              className={cn(
                'text-[8px] uppercase font-black tracking-[0.3em] mt-0.5 opacity-60 transition-colors duration-500 text-foreground/60',
                themeStyles.digitalDate
              )}
            >
