  ...
  return (
    <div style={{
      ...
      <div style={{ marginBottom: '24px' }}>
        ...
        <p style={{ fontSize: '16px', lineHeight: '24px', margin: '0', color: '#4b5563' }}>
          {isForgotPassword 
      ...
      <div style={{ marginTop: '24px', paddingTop: '24px', borderTop: '1px solid #e5e7eb' }}>
        ...
        <p style={{ fontSize: '12px', color: '#3b82f6', marginTop: '8px', wordBreak: 'break-all' }}>
          {url}
        </p>
      </div>
      ...
      <div style={{ marginTop: '24px' }}>
        <p style={{ fontSize: '12px', color: '#9ca3af', margin: '0' }}>
          Bytetools - Your ultimate toolkit.
        </p>
      </div>
    </div>
  );
