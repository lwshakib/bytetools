                    ...
                    <CardContent className="p-10 space-y-12">
                        ...
                        {session?.user && (
                            <motion.div 
                                ...
                                animate={{ opacity: 1, y: 0 }}
                                className="flex gap-4 p-6 bg-muted/20 border border-border/50 rounded-2xl"
                            >
                                <Input 
                                    ...
                                    >
                                        ...
                                        <div className="flex flex-col gap-4">
                                            ...
                                            <div className="flex items-center gap-3">
                                                <code className="text-[10px] flex-1 bg-zinc-950 px-3 py-2 rounded-xl truncate text-emerald-500/70 border border-border/30 font-mono">
                                                    {item.hashedValue}
                                                </code>
                                                <Button 
                                                    variant="ghost" 
                                                    ...
                                                    onClick={() => copyToClipboard(item.hashedValue)}
                                                >
                                            ...
                                            <div className="flex items-center gap-2 px-1">
                                                ...
                                                <span className="text-[8px] font-black uppercase tracking-widest text-muted-foreground/40">Bcrypt Salted Hash</span>
                                            </div>
                                        </div>
                                    </motion.div>
                                ))}
