...
import { Trophy, RotateCcw, User, Cpu, ShieldCheck, Zap, Activity } from 'lucide-react';
...
export default function RockPaperScissorsPage() {
  ...
  const playGame = (choice: Choice) => {
    ...
    setTimeout(() => {
      ...
      if (gameResult === 'win') { setScores(prev => ({ ...prev, user: prev.user + 1 })); }
      else if (gameResult === 'lose') { setScores(prev => ({ ...prev, computer: prev.computer + 1 })); }
      setIsPlaying(false);
    }, 800);
  };
                            ...
                            >
                                <div className="flex items-center gap-12">
                                    ...
                                    <div className="flex flex-col items-center gap-4">
                                        ...
                                        <span className="text-[8px] font-bold uppercase tracking-widest opacity-30">Core</span>
                                    </div>
                                </div>
