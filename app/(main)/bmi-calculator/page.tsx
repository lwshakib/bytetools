      ...
      <div className="flex-1 flex flex-col p-6 md:p-12">
        <div className="max-w-2xl mx-auto w-full flex flex-col items-center">
          ...
          <div className="flex flex-col items-center text-center space-y-4 mb-20 w-full">
            ...
            <p className="text-muted-foreground text-[10px] font-medium uppercase tracking-[0.2em] opacity-40">Precision body mass index computation</p>
          </div>
                ...
                <Tabs value={unit} onValueChange={(v) => setUnit(v as 'metric' | 'imperial')} className="w-full">
                  ...
                  <TabsContent value="metric" className="mt-10 space-y-10">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      ...
                      <div className="space-y-4">
                        <Label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground/40 px-1">Weight (kg)</Label>
                        <div className="relative">
                          <Input
                            type="number"
                            value={weight}
                  ...
                  <TabsContent value="imperial" className="mt-10 space-y-10">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      ...
                      <div className="space-y-4">
                        <Label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground/40 px-1">Inches</Label>
                        <Input
                          type="number"
                          value={heightInches}
                      ...
                      <div className="space-y-4">
                        <Label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground/40 px-1">Pounds</Label>
                        <Input
                          type="number"
                          value={weightPounds}
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      <div className="relative h-1.5 bg-muted/20 rounded-full overflow-hidden">
                        ...
                        <motion.div
                          initial={{ width: 0 }}
                          animate={{ left: `${Math.min(100, (bmiResult.value / 40) * 100)}%` }}
